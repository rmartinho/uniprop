...
#include <booltrie_plus_avx/structs.h++>
#include <booltrie_plus/is.h++>

namespace sg16 {
namespace booltrie_plus_avx {

template <general_category Cat>
constexpr auto table_for = sg16::booltrie_plus::table_for<Cat>;

template <>
constexpr exhaustive_list16_avx table_for<general_category::lt> = {
    {
        ...
        0x1FBC, 0x1FCC, 0x1FFC, 0x1FFC,
    }
};

template <>
constexpr exhaustive_list16_avx table_for<general_category::me> = {
    {
         0x488,  0x489, 0x1ABE, 0x20DD,
        0x20DE, 0x20DF, 0x20E0, 0x20E2,
        0x20E3, 0x20E4, 0xA670, 0xA670,
        0x20E3, 0x20E4, 0xA670, 0xA670,
    }
};

template <>
constexpr exhaustive_list16_avx table_for<general_category::pc> = {
    {
          0x5F, 0x203F, 0x2040, 0x2054,
        0xFE33, 0xFE34, 0xFE4D, 0xFE4E,
        0xFE4F, 0xFF3F, 0xFF3F, 0xFF3F,
        0xFE4F, 0xFF3F, 0xFF3F, 0xFF3F,
    }
};

template <>
constexpr exhaustive_list16_avx table_for<general_category::pd> = {
    {
...
template <>
constexpr exhaustive_list16_avx table_for<general_category::pf> = {
    {
          0xBB, 0x2019, 0x201D, 0x203A,
        0x2E03, 0x2E05, 0x2E0A, 0x2E0D,
        0x2E1D, 0x2E21, 0x2E1D, 0x2E21,
        0x2E1D, 0x2E21, 0x2E1D, 0x2E21,
    }
};

template <>
constexpr exhaustive_list16_avx table_for<general_category::pi> = {
    {
          0xAB, 0x2018, 0x201B, 0x201F,
        0x2039, 0x2E02, 0x2E04, 0x2E09,
        0x2E0C, 0x2E1C, 0x2E20, 0x2E20,
        0x2E0C, 0x2E1C, 0x2E20, 0x2E20,
    }
};

template <>
constexpr exhaustive_list16_avx table_for<general_category::z> = {
    {
...
template <>
constexpr exhaustive_list16_avx table_for<general_category::zs> = {
    {
          0x20,   0xA0, 0x1680, 0x2000,
        0x2001, 0x2002, 0x2003, 0x2004,
        0x2005, 0x2006, 0x2007, 0x2008,
